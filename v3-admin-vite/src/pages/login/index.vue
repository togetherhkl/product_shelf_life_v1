...
function handleLogin() {
  loginFormRef.value?.validate((valid) => {
    ...
    loginApi(loginFormData).then((response) => {
      ...
      userStore.setLoginInfo(response.access_token, response.username, response.role)
      // const target = route.query.redirect ? decodeURIComponent(route.query.redirect as string) : "/"
